<?php
namespace FishPig\WordPress\Block\System\Config\Integrate;

/**
 * Interceptor class for @see \FishPig\WordPress\Block\System\Config\Integrate
 */
class Interceptor extends \FishPig\WordPress\Block\System\Config\Integrate implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\Block\Template\Context $context, \FishPig\WordPress\Model\AppFactory $appFactory, \FishPig\WordPress\Model\App\Url $urlBuilder, \Magento\Store\Model\StoreManager $storeManager, \Magento\Store\Model\App\Emulation $emulator, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $appFactory, $urlBuilder, $storeManager, $emulator, $data);
    }
