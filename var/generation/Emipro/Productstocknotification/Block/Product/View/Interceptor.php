<?php
namespace Emipro\Productstocknotification\Block\Product\View;

/**
 * Interceptor class for @see \Emipro\Productstocknotification\Block\Product\View
 */
class Interceptor extends \Emipro\Productstocknotification\Block\Product\View implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPostformUrl');
        if (!$pluginInfo) {
            return parent::getPostformUrl($url);
        } else {
            return $this->___callPlugins('getPostformUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getParamId');
        if (!$pluginInfo) {
            return parent::getParamId($param);
        } else {
            return $this->___callPlugins('getParamId', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getStockItem($productId)
    {
        ...
        if (!$pluginInfo) {
            return parent::getStockItem($productId);
        } else {
