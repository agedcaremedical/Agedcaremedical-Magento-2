...
class Interceptor extends \Anowave\Ec\Block\Track implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Sales\Model\ResourceModel\Order\CollectionFactory $salesOrderCollection, \Anowave\Ec\Helper\Data $helper, \Anowave\Ec\Helper\Datalayer $dataLayer, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $salesOrderCollection, $helper, $dataLayer, $data);
    }
