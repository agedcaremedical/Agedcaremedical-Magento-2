<?php
namespace Anowave\Ec\Block\Comment;

/**
 * Interceptor class for @see \Anowave\Ec\Block\Comment
 */
class Interceptor extends \Anowave\Ec\Block\Comment implements \Magento\Framework\Interception\InterceptorInterface
{
