<?php
namespace LiveChat\LiveChat\Block\SnippetBlock;

/**
 * Interceptor class for @see \LiveChat\LiveChat\Block\SnippetBlock
 */
class Interceptor extends \LiveChat\LiveChat\Block\SnippetBlock implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \LiveChat\LiveChat\Helper\Data $dataHelper, array $data = array())
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLicenseId');
        if (!$pluginInfo) {
            return parent::getLicenseId();
        } else {
            return $this->___callPlugins('getLicenseId', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCustomerDetails()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getCustomerDetails', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCustomVariables()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCustomVariables();
        } else {
            return $this->___callPlugins('getCustomVariables', func_get_args(), $pluginInfo);
        }
    }
