...
class Interceptor extends \MageWorx\SeoXTemplates\Model\ResourceModel\Category implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getAttributeRawValue($magentoentityId, $magentoattribute, $magentostore)
    {
        ...
        if (!$pluginInfo) {
            return parent::getAttributeRawValue($magentoentityId, $magentoattribute, $magentostore);
        } else {
