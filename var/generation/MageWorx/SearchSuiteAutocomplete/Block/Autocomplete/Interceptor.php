...
/**
 * Interceptor class for @see \MageWorx\SearchSuiteAutocomplete\Block\Autocomplete
 */
class Interceptor extends \MageWorx\SearchSuiteAutocomplete\Block\Autocomplete implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\MageWorx\SearchSuiteAutocomplete\Helper\Data $helperData, \Magento\Framework\View\Element\Template\Context $context, array $data = array())
    {
        $this->___init();
        parent::__construct($helperData, $context, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSearchDelay');
        if (!$pluginInfo) {
            return parent::getSearchDelay();
        } else {
            return $this->___callPlugins('getSearchDelay', func_get_args(), $pluginInfo);
        }
    }
