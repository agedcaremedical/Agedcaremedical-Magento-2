<?php
namespace MageWorx\SeoMarkup\Block\Head\SocialMarkup\Product;

/**
 * Interceptor class for @see \MageWorx\SeoMarkup\Block\Head\SocialMarkup\Product
 */
class Interceptor extends \MageWorx\SeoMarkup\Block\Head\SocialMarkup\Product implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\MageWorx\SeoMarkup\Helper\Product $helperProduct, \MageWorx\SeoMarkup\Helper\DataProvider\Product $helperDataProvider, \MageWorx\SeoMarkup\Helper\Website $helperWebsite, \Magento\Framework\Registry $registry, \Magento\Framework\View\Element\Template\Context $context, array $data)
    {
        $this->___init();
        parent::__construct($helperProduct, $helperDataProvider, $helperWebsite, $registry, $context, $data);
    }
