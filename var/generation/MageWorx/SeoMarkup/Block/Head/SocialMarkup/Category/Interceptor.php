...
class Interceptor extends \MageWorx\SeoMarkup\Block\Head\SocialMarkup\Category implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\MageWorx\SeoMarkup\Helper\Category $helperCategory, \MageWorx\SeoMarkup\Helper\Website $helperWebsite, \Magento\Framework\View\Element\Template\Context $context, array $data)
    {
        $this->___init();
        parent::__construct($helperCategory, $helperWebsite, $context, $data);
    }
