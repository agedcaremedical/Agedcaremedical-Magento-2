...
class Interceptor extends \MageWorx\SeoMarkup\Block\Head\SocialMarkup\Page\DefaultPage implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\MageWorx\SeoMarkup\Helper\Page $helperPage, \MageWorx\SeoMarkup\Helper\Website $helperWebsite, \Magento\Framework\Registry $registry, \Magento\Framework\View\Element\Template\Context $context, array $data)
    {
        $this->___init();
        parent::__construct($helperPage, $helperWebsite, $registry, $context, $data);
    }
