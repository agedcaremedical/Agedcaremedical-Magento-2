<?php
namespace MageWorx\SeoMarkup\Block\Head\Json\Website;

/**
 * Interceptor class for @see \MageWorx\SeoMarkup\Block\Head\Json\Website
 */
class Interceptor extends \MageWorx\SeoMarkup\Block\Head\Json\Website implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\MageWorx\SeoMarkup\Helper\Website $helperWebsite, \Magento\Framework\View\Element\Template\Context $context, array $data = array())
    {
        $this->___init();
        parent::__construct($helperWebsite, $context, $data);
    }
