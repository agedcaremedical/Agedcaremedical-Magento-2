<?php
namespace MageWorx\SeoMarkup\Block\Head\Json\Breadcrumbs\Catalog;

/**
 * Interceptor class for @see \MageWorx\SeoMarkup\Block\Head\Json\Breadcrumbs\Catalog
 */
class Interceptor extends \MageWorx\SeoMarkup\Block\Head\Json\Breadcrumbs\Catalog implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\MageWorx\SeoMarkup\Helper\Breadcrumbs $helperBreadcrumbs, \Magento\Catalog\Helper\Data $helperCatalogData, \Magento\Framework\View\Element\Template\Context $context, array $data = array())
    {
        $this->___init();
        parent::__construct($helperBreadcrumbs, $helperCatalogData, $context, $data);
    }
