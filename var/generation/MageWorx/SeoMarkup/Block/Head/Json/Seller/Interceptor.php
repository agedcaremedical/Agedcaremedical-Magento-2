<?php
namespace MageWorx\SeoMarkup\Block\Head\Json\Seller;

/**
 * Interceptor class for @see \MageWorx\SeoMarkup\Block\Head\Json\Seller
 */
class Interceptor extends \MageWorx\SeoMarkup\Block\Head\Json\Seller implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\MageWorx\SeoMarkup\Helper\Seller $helperSeller, \Magento\Framework\View\Element\Template\Context $context, array $data = array())
    {
        $this->___init();
