<?php
namespace MageWorx\SeoMarkup\Block\Head\Json\Product;

/**
 * Interceptor class for @see \MageWorx\SeoMarkup\Block\Head\Json\Product
 */
class Interceptor extends \MageWorx\SeoMarkup\Block\Head\Json\Product implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Registry $registry, \MageWorx\SeoMarkup\Helper\Product $helperProduct, \MageWorx\SeoMarkup\Helper\DataProvider\Product $dataProviderProduct, \Magento\Framework\View\Element\Template\Context $context, array $data = array())
    {
        $this->___init();
        parent::__construct($registry, $helperProduct, $dataProviderProduct, $context, $data);
    }
