...
class Interceptor extends \Infortis\Brands\Block\Brands implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLoadedBrands');
        if (!$pluginInfo) {
            return parent::getLoadedBrands();
        } else {
            return $this->___callPlugins('getLoadedBrands', func_get_args(), $pluginInfo);
        }
    }
