...
class Interceptor extends \Infortis\Brands\Block\Logo implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Infortis\Brands\Helper\Data $helperData, \Magento\Eav\Model\Config $modelConfig, \Magento\Framework\Registry $frameworkRegistry, \Magento\Catalog\Model\Product\Url $productUrl, array $data = array())
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRegistry');
        if (!$pluginInfo) {
            return parent::getRegistry();
        } else {
            return $this->___callPlugins('getRegistry', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentProductObject');
        if (!$pluginInfo) {
            return parent::getCurrentProductObject();
        } else {
            return $this->___callPlugins('getCurrentProductObject', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBrandAttributeId');
        if (!$pluginInfo) {
            return parent::getBrandAttributeId();
        } else {
            return $this->___callPlugins('getBrandAttributeId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBrandAttributeTitle');
        if (!$pluginInfo) {
            return parent::getBrandAttributeTitle();
        } else {
            return $this->___callPlugins('getBrandAttributeTitle', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getBrand($product)
    {
        ...
        if (!$pluginInfo) {
            return parent::getBrand($product);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBrandImageUrl');
        if (!$pluginInfo) {
            return parent::getBrandImageUrl($brand);
        } else {
            return $this->___callPlugins('getBrandImageUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBrandPageUrl');
        if (!$pluginInfo) {
            return parent::getBrandPageUrl($brand);
        } else {
            return $this->___callPlugins('getBrandPageUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBrandUrlKey');
        if (!$pluginInfo) {
            return parent::getBrandUrlKey($brand, $separator);
        } else {
            return $this->___callPlugins('getBrandUrlKey', func_get_args(), $pluginInfo);
        }
    }
