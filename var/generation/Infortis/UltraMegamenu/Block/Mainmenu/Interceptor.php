...
class Interceptor extends \Infortis\UltraMegamenu\Block\Mainmenu implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHelperConnectorBaseTheme');
        if (!$pluginInfo) {
            return parent::getHelperConnectorBaseTheme();
        } else {
            return $this->___callPlugins('getHelperConnectorBaseTheme', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStaticBlockTitle');
        if (!$pluginInfo) {
            return parent::getStaticBlockTitle($id);
        } else {
            return $this->___callPlugins('getStaticBlockTitle', func_get_args(), $pluginInfo);
        }
    }
