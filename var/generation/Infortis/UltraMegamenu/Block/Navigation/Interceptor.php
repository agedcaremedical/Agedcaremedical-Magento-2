...
class Interceptor extends \Infortis\UltraMegamenu\Block\Navigation implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderCategoriesMenuHtml');
        if (!$pluginInfo) {
            return parent::renderCategoriesMenuHtml($isAccordion, $level, $outermostItemClass, $childrenWrapClass);
        } else {
            return $this->___callPlugins('renderCategoriesMenuHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderMe');
        if (!$pluginInfo) {
            return parent::renderMe($isAccordion, $parent, $recursionLevel);
        } else {
            return $this->___callPlugins('renderMe', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderBlockTitle');
        if (!$pluginInfo) {
            return parent::renderBlockTitle();
        } else {
            return $this->___callPlugins('renderBlockTitle', func_get_args(), $pluginInfo);
        }
    }
