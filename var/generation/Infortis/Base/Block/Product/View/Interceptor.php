...
class Interceptor extends \Infortis\Base\Block\Product\View implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Infortis\Base\Helper\Data $helperData, \Infortis\Base\Helper\Template\Catalog\Product\View $helperTemplateProductView, \Magento\Framework\Registry $registry, array $data = array())
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHelperProductView');
        if (!$pluginInfo) {
            return parent::getHelperProductView();
        } else {
            return $this->___callPlugins('getHelperProductView', func_get_args(), $pluginInfo);
        }
    }
