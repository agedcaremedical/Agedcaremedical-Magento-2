...
class Interceptor extends \Infortis\Base\Block\Product\ProductList\Featured implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLabelHelper');
        if (!$pluginInfo) {
            return parent::getLabelHelper();
        } else {
            return $this->___callPlugins('getLabelHelper', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCatalogHelperOutput');
        if (!$pluginInfo) {
            return parent::getCatalogHelperOutput();
        } else {
            return $this->___callPlugins('getCatalogHelperOutput', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUniqueCollectionId');
        if (!$pluginInfo) {
            return parent::getUniqueCollectionId();
        } else {
            return $this->___callPlugins('getUniqueCollectionId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCollectionCount');
        if (!$pluginInfo) {
            return parent::getCollectionCount();
        } else {
            return $this->___callPlugins('getCollectionCount', func_get_args(), $pluginInfo);
        }
    }
