...
class Interceptor extends \Infortis\Base\Block\Html\Header implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Infortis\Base\Helper\Data $helperData, \Infortis\Base\Helper\Template\Theme\Html\Header $helperTemplateHtmlHeader, \Infortis\Infortis\Helper\Connector\Infortis\UltraMegamenu $helperConnectorUltraMegamenu, array $data = array())
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHelperTheme');
        if (!$pluginInfo) {
            return parent::getHelperTheme();
        } else {
            return $this->___callPlugins('getHelperTheme', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHelperHeader');
        if (!$pluginInfo) {
            return parent::getHelperHeader();
        } else {
            return $this->___callPlugins('getHelperHeader', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHelperConnectorMenu');
        if (!$pluginInfo) {
            return parent::getHelperConnectorMenu();
        } else {
            return $this->___callPlugins('getHelperConnectorMenu', func_get_args(), $pluginInfo);
        }
    }
