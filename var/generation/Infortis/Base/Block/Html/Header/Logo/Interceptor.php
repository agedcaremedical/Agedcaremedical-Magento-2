...
class Interceptor extends \Infortis\Base\Block\Html\Header\Logo implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStickyLogoSrc');
        if (!$pluginInfo) {
            return parent::getStickyLogoSrc();
        } else {
            return $this->___callPlugins('getStickyLogoSrc', func_get_args(), $pluginInfo);
        }
    }
