...
class Interceptor extends \Infortis\Cgen\Block\Asset\Css implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoreViewCode');
        if (!$pluginInfo) {
            return parent::getStoreViewCode();
        } else {
            return $this->___callPlugins('getStoreViewCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isColor');
        if (!$pluginInfo) {
            return parent::isColor($color);
        } else {
            return $this->___callPlugins('isColor', func_get_args(), $pluginInfo);
        }
    }
