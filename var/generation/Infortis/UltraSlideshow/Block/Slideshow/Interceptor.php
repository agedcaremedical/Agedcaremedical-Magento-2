...
class Interceptor extends \Infortis\UltraSlideshow\Block\Slideshow implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Infortis\UltraSlideshow\Helper\Data $helperData, \Magento\Customer\Model\Session $modelSession, \Magento\Framework\View\LayoutFactory $viewLayoutFactory, \Magento\Cms\Model\BlockFactory $cmsBlockModelFactory, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $helperData, $modelSession, $viewLayoutFactory, $cmsBlockModelFactory, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFrontendHash');
        if (!$pluginInfo) {
            return parent::getFrontendHash();
        } else {
            return $this->___callPlugins('getFrontendHash', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSlideIds');
        if (!$pluginInfo) {
            return parent::getSlideIds();
        } else {
            return $this->___callPlugins('getSlideIds', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getParamStaticBlockIds');
        if (!$pluginInfo) {
            return parent::getParamStaticBlockIds();
        } else {
            return $this->___callPlugins('getParamStaticBlockIds', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConfigStaticBlockIds');
        if (!$pluginInfo) {
            return parent::getConfigStaticBlockIds();
        } else {
            return $this->___callPlugins('getConfigStaticBlockIds', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBannersId');
        if (!$pluginInfo) {
            return parent::getBannersId();
        } else {
            return $this->___callPlugins('getBannersId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBannersHtml');
        if (!$pluginInfo) {
            return parent::getBannersHtml();
        } else {
            return $this->___callPlugins('getBannersHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSlides');
        if (!$pluginInfo) {
            return parent::addSlides($ids);
        } else {
            return $this->___callPlugins('addSlides', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addBanner');
        if (!$pluginInfo) {
            return parent::addBanner($ids);
        } else {
            return $this->___callPlugins('addBanner', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setPredefined');
        if (!$pluginInfo) {
            return parent::setPredefined($value);
        } else {
            return $this->___callPlugins('setPredefined', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isPredefined');
        if (!$pluginInfo) {
            return parent::isPredefined();
        } else {
            return $this->___callPlugins('isPredefined', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMarginStyles');
        if (!$pluginInfo) {
            return parent::getMarginStyles();
        } else {
            return $this->___callPlugins('getMarginStyles', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSlideshowCfg');
        if (!$pluginInfo) {
            return parent::getSlideshowCfg();
        } else {
            return $this->___callPlugins('getSlideshowCfg', func_get_args(), $pluginInfo);
        }
    }
