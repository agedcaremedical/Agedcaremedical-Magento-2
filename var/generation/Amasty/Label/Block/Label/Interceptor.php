<?php
namespace Amasty\Label\Block\Label;

/**
 * Interceptor class for @see \Amasty\Label\Block\Label
 */
class Interceptor extends \Amasty\Label\Block\Label implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Amasty\Label\Helper\Data $helper, array $data = array())
    {
        $this->___init();
    ...
    public function setLabel(\Amasty\Label\Model\Labels $label)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('setLabel', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContainerPath');
        if (!$pluginInfo) {
            return parent::getContainerPath();
        } else {
            return $this->___callPlugins('getContainerPath', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImageScr');
        if (!$pluginInfo) {
            return parent::getImageScr();
        } else {
            return $this->___callPlugins('getImageScr', func_get_args(), $pluginInfo);
        }
    }
