...
class Interceptor extends \Magento\Integration\Block\Adminhtml\Integration\Grid implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRowClickCallback');
        if (!$pluginInfo) {
            return parent::getRowClickCallback();
        } else {
            return $this->___callPlugins('getRowClickCallback', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRowInitCallback');
        if (!$pluginInfo) {
            return parent::getRowInitCallback();
        } else {
            return $this->___callPlugins('getRowInitCallback', func_get_args(), $pluginInfo);
        }
    }
