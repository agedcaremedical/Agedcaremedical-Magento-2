...
class Interceptor extends \Magento\Framework\View\Element\Html\Calendar implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getTimezoneOffsetSeconds()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getTimezoneOffsetSeconds', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getStoreTimestamp($store = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getStoreTimestamp($store);
        } else {
            return $this->___callPlugins('getStoreTimestamp', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getYearRange()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getYearRange', func_get_args(), $pluginInfo);
        }
    }
