...
class Interceptor extends \Magento\Directory\Block\Currency implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getCurrencyCount()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCurrencyCount();
        } else {
            return $this->___callPlugins('getCurrencyCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCurrencies()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getCurrencies', func_get_args(), $pluginInfo);
        }
    }
