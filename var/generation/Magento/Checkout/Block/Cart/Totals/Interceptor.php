...
class Interceptor extends \Magento\Checkout\Block\Cart\Totals implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'needDisplayBaseGrandtotal');
        if (!$pluginInfo) {
            return parent::needDisplayBaseGrandtotal();
        } else {
            return $this->___callPlugins('needDisplayBaseGrandtotal', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'displayBaseGrandtotal');
        if (!$pluginInfo) {
            return parent::displayBaseGrandtotal();
        } else {
            return $this->___callPlugins('displayBaseGrandtotal', func_get_args(), $pluginInfo);
        }
    }
