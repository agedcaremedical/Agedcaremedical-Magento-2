...
class Interceptor extends \Magento\Checkout\Block\Cart\Item\Renderer\Actions\Remove implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDeletePostJson');
        if (!$pluginInfo) {
            return parent::getDeletePostJson();
        } else {
            return $this->___callPlugins('getDeletePostJson', func_get_args(), $pluginInfo);
        }
    }
