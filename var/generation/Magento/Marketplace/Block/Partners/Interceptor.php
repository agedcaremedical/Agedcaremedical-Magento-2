...
class Interceptor extends \Magento\Marketplace\Block\Partners implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPartners');
        if (!$pluginInfo) {
            return parent::getPartners();
        } else {
            return $this->___callPlugins('getPartners', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPartnersModel');
        if (!$pluginInfo) {
            return parent::getPartnersModel();
        } else {
            return $this->___callPlugins('getPartnersModel', func_get_args(), $pluginInfo);
        }
    }
