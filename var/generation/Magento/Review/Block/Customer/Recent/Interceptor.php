...
class Interceptor extends \Magento\Review\Block\Customer\Recent implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getReviews');
        if (!$pluginInfo) {
            return parent::getReviews();
        } else {
            return $this->___callPlugins('getReviews', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getReviewLink');
        if (!$pluginInfo) {
            return parent::getReviewLink();
        } else {
            return $this->___callPlugins('getReviewLink', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductLink');
        if (!$pluginInfo) {
            return parent::getProductLink();
        } else {
            return $this->___callPlugins('getProductLink', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllReviewsUrl');
        if (!$pluginInfo) {
            return parent::getAllReviewsUrl();
        } else {
            return $this->___callPlugins('getAllReviewsUrl', func_get_args(), $pluginInfo);
        }
    }
