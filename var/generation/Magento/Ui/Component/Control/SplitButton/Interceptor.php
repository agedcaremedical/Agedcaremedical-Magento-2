...
class Interceptor extends \Magento\Ui\Component\Control\SplitButton implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getAttributesHtml()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getAttributesHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getButtonAttributesHtml');
        if (!$pluginInfo) {
            return parent::getButtonAttributesHtml();
        } else {
            return $this->___callPlugins('getButtonAttributesHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getToggleAttributesHtml');
        if (!$pluginInfo) {
            return parent::getToggleAttributesHtml();
        } else {
            return $this->___callPlugins('getToggleAttributesHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOptionAttributesHtml');
        if (!$pluginInfo) {
            return parent::getOptionAttributesHtml($key, $option);
        } else {
            return $this->___callPlugins('getOptionAttributesHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasSplit');
        if (!$pluginInfo) {
            return parent::hasSplit();
        } else {
            return $this->___callPlugins('hasSplit', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getOnClick()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getOnClick', func_get_args(), $pluginInfo);
        }
    }
