...
class Interceptor extends \Magento\Paypal\Block\Logo implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAboutPaypalPageUrl');
        if (!$pluginInfo) {
            return parent::getAboutPaypalPageUrl();
        } else {
            return $this->___callPlugins('getAboutPaypalPageUrl', func_get_args(), $pluginInfo);
        }
    }
