...
class Interceptor extends \Magento\Customer\Block\Form\Login\Info implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getRegistration()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getRegistration', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCreateAccountUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCreateAccountUrl();
        } else {
            return $this->___callPlugins('getCreateAccountUrl', func_get_args(), $pluginInfo);
        }
    }
