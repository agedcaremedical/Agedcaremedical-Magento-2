...
class Interceptor extends \Magento\Customer\Block\Account\Dashboard\Address implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPrimaryShippingAddressHtml');
        if (!$pluginInfo) {
            return parent::getPrimaryShippingAddressHtml();
        } else {
            return $this->___callPlugins('getPrimaryShippingAddressHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPrimaryBillingAddressHtml');
        if (!$pluginInfo) {
            return parent::getPrimaryBillingAddressHtml();
        } else {
            return $this->___callPlugins('getPrimaryBillingAddressHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPrimaryShippingAddressEditUrl');
        if (!$pluginInfo) {
            return parent::getPrimaryShippingAddressEditUrl();
        } else {
            return $this->___callPlugins('getPrimaryShippingAddressEditUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPrimaryBillingAddressEditUrl');
        if (!$pluginInfo) {
            return parent::getPrimaryBillingAddressEditUrl();
        } else {
            return $this->___callPlugins('getPrimaryBillingAddressEditUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddressBookUrl');
        if (!$pluginInfo) {
            return parent::getAddressBookUrl();
        } else {
            return $this->___callPlugins('getAddressBookUrl', func_get_args(), $pluginInfo);
        }
    }
