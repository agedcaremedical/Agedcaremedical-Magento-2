...
class Interceptor extends \Magento\Customer\Block\Account\Dashboard implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getAccountUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getAccountUrl();
        } else {
            return $this->___callPlugins('getAccountUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddressesUrl');
        if (!$pluginInfo) {
            return parent::getAddressesUrl();
        } else {
            return $this->___callPlugins('getAddressesUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOrdersUrl');
        if (!$pluginInfo) {
            return parent::getOrdersUrl();
        } else {
            return $this->___callPlugins('getOrdersUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWishlistUrl');
        if (!$pluginInfo) {
            return parent::getWishlistUrl();
        } else {
            return $this->___callPlugins('getWishlistUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSubscriptionObject');
        if (!$pluginInfo) {
            return parent::getSubscriptionObject();
        } else {
            return $this->___callPlugins('getSubscriptionObject', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getManageNewsletterUrl');
        if (!$pluginInfo) {
            return parent::getManageNewsletterUrl();
        } else {
            return $this->___callPlugins('getManageNewsletterUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSubscriptionText');
        if (!$pluginInfo) {
            return parent::getSubscriptionText();
        } else {
            return $this->___callPlugins('getSubscriptionText', func_get_args(), $pluginInfo);
        }
    }
