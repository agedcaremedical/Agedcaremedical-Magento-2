...
class Interceptor extends \Magento\Customer\Block\Account\Dashboard\Info implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getChangePasswordUrl');
        if (!$pluginInfo) {
            return parent::getChangePasswordUrl();
        } else {
            return $this->___callPlugins('getChangePasswordUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIsSubscribed');
        if (!$pluginInfo) {
            return parent::getIsSubscribed();
        } else {
            return $this->___callPlugins('getIsSubscribed', func_get_args(), $pluginInfo);
        }
    }
