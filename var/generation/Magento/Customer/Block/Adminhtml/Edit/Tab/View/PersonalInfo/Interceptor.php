...
class Interceptor extends \Magento\Customer\Block\Adminhtml\Edit\Tab\View\PersonalInfo implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setCustomerRegistry');
        if (!$pluginInfo) {
            return parent::setCustomerRegistry($customerRegistry);
        } else {
            return $this->___callPlugins('setCustomerRegistry', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCustomerRegistry');
        if (!$pluginInfo) {
            return parent::getCustomerRegistry();
        } else {
            return $this->___callPlugins('getCustomerRegistry', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoreCreateDate');
        if (!$pluginInfo) {
            return parent::getStoreCreateDate();
        } else {
            return $this->___callPlugins('getStoreCreateDate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoreCreateDateTimezone');
        if (!$pluginInfo) {
            return parent::getStoreCreateDateTimezone();
        } else {
            return $this->___callPlugins('getStoreCreateDateTimezone', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCreateDate');
        if (!$pluginInfo) {
            return parent::getCreateDate();
        } else {
            return $this->___callPlugins('getCreateDate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIsConfirmedStatus');
        if (!$pluginInfo) {
            return parent::getIsConfirmedStatus();
        } else {
            return $this->___callPlugins('getIsConfirmedStatus', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCreatedInStore');
        if (!$pluginInfo) {
            return parent::getCreatedInStore();
        } else {
            return $this->___callPlugins('getCreatedInStore', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBillingAddressHtml');
        if (!$pluginInfo) {
            return parent::getBillingAddressHtml();
        } else {
            return $this->___callPlugins('getBillingAddressHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGroupName');
        if (!$pluginInfo) {
            return parent::getGroupName();
        } else {
            return $this->___callPlugins('getGroupName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoreLastLoginDateTimezone');
        if (!$pluginInfo) {
            return parent::getStoreLastLoginDateTimezone();
        } else {
            return $this->___callPlugins('getStoreLastLoginDateTimezone', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentStatus');
        if (!$pluginInfo) {
            return parent::getCurrentStatus();
        } else {
            return $this->___callPlugins('getCurrentStatus', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLastLoginDate');
        if (!$pluginInfo) {
            return parent::getLastLoginDate();
        } else {
            return $this->___callPlugins('getLastLoginDate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoreLastLoginDate');
        if (!$pluginInfo) {
            return parent::getStoreLastLoginDate();
        } else {
            return $this->___callPlugins('getStoreLastLoginDate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAccountLock');
        if (!$pluginInfo) {
            return parent::getAccountLock();
        } else {
            return $this->___callPlugins('getAccountLock', func_get_args(), $pluginInfo);
        }
    }
