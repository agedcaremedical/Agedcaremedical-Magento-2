...
class Interceptor extends \Magento\Customer\Block\Adminhtml\Edit\Tab\Newsletter implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function isAjaxLoaded()
    {
        ...
        if (!$pluginInfo) {
            return parent::isAjaxLoaded();
        } else {
            return $this->___callPlugins('isAjaxLoaded', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getStatusChangedDate()
    {
        ...
        if (!$pluginInfo) {
            return parent::getStatusChangedDate();
        } else {
            return $this->___callPlugins('getStatusChangedDate', func_get_args(), $pluginInfo);
        }
    }
