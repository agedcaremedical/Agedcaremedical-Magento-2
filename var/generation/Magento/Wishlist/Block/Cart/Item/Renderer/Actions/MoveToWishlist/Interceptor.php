...
class Interceptor extends \Magento\Wishlist\Block\Cart\Item\Renderer\Actions\MoveToWishlist implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isAllowInCart');
        if (!$pluginInfo) {
            return parent::isAllowInCart();
        } else {
            return $this->___callPlugins('isAllowInCart', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMoveFromCartParams');
        if (!$pluginInfo) {
            return parent::getMoveFromCartParams();
        } else {
            return $this->___callPlugins('getMoveFromCartParams', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isProductVisibleInSiteVisibility');
        if (!$pluginInfo) {
            return parent::isProductVisibleInSiteVisibility();
        } else {
            return $this->___callPlugins('isProductVisibleInSiteVisibility', func_get_args(), $pluginInfo);
        }
    }
