...
class Interceptor extends \Magento\Widget\Block\Adminhtml\Widget\Instance\Edit implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getValidationUrl');
        if (!$pluginInfo) {
            return parent::getValidationUrl();
        } else {
            return $this->___callPlugins('getValidationUrl', func_get_args(), $pluginInfo);
        }
    }
