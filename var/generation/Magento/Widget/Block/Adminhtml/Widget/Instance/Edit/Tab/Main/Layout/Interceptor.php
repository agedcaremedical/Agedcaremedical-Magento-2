...
class Interceptor extends \Magento\Widget\Block\Adminhtml\Widget\Instance\Edit\Tab\Main\Layout implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\Block\Template\Context $context, \Magento\Catalog\Model\Product\Type $productType, array $data = array())
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoriesChooserUrl');
        if (!$pluginInfo) {
            return parent::getCategoriesChooserUrl();
        } else {
            return $this->___callPlugins('getCategoriesChooserUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductsChooserUrl');
        if (!$pluginInfo) {
            return parent::getProductsChooserUrl();
        } else {
            return $this->___callPlugins('getProductsChooserUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBlockChooserUrl');
        if (!$pluginInfo) {
            return parent::getBlockChooserUrl();
        } else {
            return $this->___callPlugins('getBlockChooserUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTemplateChooserUrl');
        if (!$pluginInfo) {
            return parent::getTemplateChooserUrl();
        } else {
            return $this->___callPlugins('getTemplateChooserUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDisplayOnSelectHtml');
        if (!$pluginInfo) {
            return parent::getDisplayOnSelectHtml();
        } else {
            return $this->___callPlugins('getDisplayOnSelectHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getDisplayOnContainers()
    {
        ...
        if (!$pluginInfo) {
            return parent::getDisplayOnContainers();
        } else {
            return $this->___callPlugins('getDisplayOnContainers', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLayoutsChooser');
        if (!$pluginInfo) {
            return parent::getLayoutsChooser();
        } else {
            return $this->___callPlugins('getLayoutsChooser', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPageLayoutsPageChooser');
        if (!$pluginInfo) {
            return parent::getPageLayoutsPageChooser();
        } else {
            return $this->___callPlugins('getPageLayoutsPageChooser', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddLayoutButtonHtml');
        if (!$pluginInfo) {
            return parent::getAddLayoutButtonHtml();
        } else {
            return $this->___callPlugins('getAddLayoutButtonHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRemoveLayoutButtonHtml');
        if (!$pluginInfo) {
            return parent::getRemoveLayoutButtonHtml();
        } else {
            return $this->___callPlugins('getRemoveLayoutButtonHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPageGroups');
        if (!$pluginInfo) {
            return parent::getPageGroups();
        } else {
            return $this->___callPlugins('getPageGroups', func_get_args(), $pluginInfo);
        }
    }
