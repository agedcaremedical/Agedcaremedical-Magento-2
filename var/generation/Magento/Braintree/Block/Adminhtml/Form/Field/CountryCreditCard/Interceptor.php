...
class Interceptor extends \Magento\Braintree\Block\Adminhtml\Form\Field\CountryCreditCard implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getArrayRows()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getArrayRows', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function renderCellTemplate($columnName)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('renderCellTemplate', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isAddAfter()
    {
        ...
        if (!$pluginInfo) {
            return parent::isAddAfter();
        } else {
            return $this->___callPlugins('isAddAfter', func_get_args(), $pluginInfo);
        }
    }
