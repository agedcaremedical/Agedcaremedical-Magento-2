...
class Interceptor extends \Magento\AdminNotification\Block\System\Messages\UnreadMessagePopup implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getUnreadMessages()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getUnreadMessages', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getPopupTitle()
    {
        ...
        if (!$pluginInfo) {
            return parent::getPopupTitle();
        } else {
            return $this->___callPlugins('getPopupTitle', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getItemClass(\Magento\Framework\Notification\MessageInterface $message)
    {
        ...
        if (!$pluginInfo) {
            return parent::getItemClass($message);
        } else {
            return $this->___callPlugins('getItemClass', func_get_args(), $pluginInfo);
        }
    }
