...
class Interceptor extends \Magento\AdminNotification\Block\System\Messages implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLastCritical');
        if (!$pluginInfo) {
            return parent::getLastCritical();
        } else {
            return $this->___callPlugins('getLastCritical', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCriticalCount');
        if (!$pluginInfo) {
            return parent::getCriticalCount();
        } else {
            return $this->___callPlugins('getCriticalCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMajorCount');
        if (!$pluginInfo) {
            return parent::getMajorCount();
        } else {
            return $this->___callPlugins('getMajorCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSystemMessageDialogJson');
        if (!$pluginInfo) {
            return parent::getSystemMessageDialogJson();
        } else {
            return $this->___callPlugins('getSystemMessageDialogJson', func_get_args(), $pluginInfo);
        }
    }
