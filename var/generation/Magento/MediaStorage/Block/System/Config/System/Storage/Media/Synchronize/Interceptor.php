...
class Interceptor extends \Magento\MediaStorage\Block\System\Config\System\Storage\Media\Synchronize implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAjaxSyncUrl');
        if (!$pluginInfo) {
            return parent::getAjaxSyncUrl();
        } else {
            return $this->___callPlugins('getAjaxSyncUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAjaxStatusUpdateUrl');
        if (!$pluginInfo) {
            return parent::getAjaxStatusUpdateUrl();
        } else {
            return $this->___callPlugins('getAjaxStatusUpdateUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSyncStorageParams');
        if (!$pluginInfo) {
            return parent::getSyncStorageParams();
        } else {
            return $this->___callPlugins('getSyncStorageParams', func_get_args(), $pluginInfo);
        }
    }
