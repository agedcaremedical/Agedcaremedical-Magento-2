...
class Interceptor extends \Magento\Backend\Block\Cache\Grid\Column\Statuses implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFrameCallback');
        if (!$pluginInfo) {
            return parent::getFrameCallback();
        } else {
            return $this->___callPlugins('getFrameCallback', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'decorateStatus');
        if (!$pluginInfo) {
            return parent::decorateStatus($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('decorateStatus', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setGrid($grid)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('setGrid', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getHtmlProperty()
    {
        ...
        if (!$pluginInfo) {
            return parent::getHtmlProperty();
        } else {
            return $this->___callPlugins('getHtmlProperty', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCssProperty()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCssProperty();
        } else {
            return $this->___callPlugins('getCssProperty', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSortable()
    {
        ...
        if (!$pluginInfo) {
            return parent::getSortable();
        } else {
            return $this->___callPlugins('getSortable', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addHeaderCssClass($className)
    {
        ...
        if (!$pluginInfo) {
            return parent::addHeaderCssClass($className);
        } else {
            return $this->___callPlugins('addHeaderCssClass', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getHeaderHtmlProperty()
    {
        ...
        if (!$pluginInfo) {
            return parent::getHeaderHtmlProperty();
        } else {
            return $this->___callPlugins('getHeaderHtmlProperty', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getRowField(\Magento\Framework\DataObject $row)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getRowField', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getRowFieldExport(\Magento\Framework\DataObject $row)
    {
        ...
        if (!$pluginInfo) {
            return parent::getRowFieldExport($row);
        } else {
            return $this->___callPlugins('getRowFieldExport', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getExportHeader()
    {
        ...
        if (!$pluginInfo) {
            return parent::getExportHeader();
        } else {
            return $this->___callPlugins('getExportHeader', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setFilter($filterClass)
    {
        ...
        if (!$pluginInfo) {
            return parent::setFilter($filterClass);
        } else {
    ...
    public function getFilterHtml()
    {
        ...
        if (!$pluginInfo) {
            return parent::getFilterHtml();
        } else {
            return $this->___callPlugins('getFilterHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isGrouped()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('isGrouped', func_get_args(), $pluginInfo);
        }
    }
