...
class Interceptor extends \Magento\Backend\Block\Cache\Additional implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isInProductionMode');
        if (!$pluginInfo) {
            return parent::isInProductionMode();
        } else {
            return $this->___callPlugins('isInProductionMode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCleanImagesUrl');
        if (!$pluginInfo) {
            return parent::getCleanImagesUrl();
        } else {
            return $this->___callPlugins('getCleanImagesUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCleanMediaUrl');
        if (!$pluginInfo) {
            return parent::getCleanMediaUrl();
        } else {
            return $this->___callPlugins('getCleanMediaUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCleanStaticFilesUrl');
        if (!$pluginInfo) {
            return parent::getCleanStaticFilesUrl();
        } else {
            return $this->___callPlugins('getCleanStaticFilesUrl', func_get_args(), $pluginInfo);
        }
    }
