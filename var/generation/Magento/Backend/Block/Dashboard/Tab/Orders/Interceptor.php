...
class Interceptor extends \Magento\Backend\Block\Dashboard\Tab\Orders implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setDataRows');
        if (!$pluginInfo) {
            return parent::setDataRows($rows);
        } else {
            return $this->___callPlugins('setDataRows', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSeries');
        if (!$pluginInfo) {
            return parent::addSeries($seriesId, $options);
        } else {
            return $this->___callPlugins('addSeries', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSeries');
        if (!$pluginInfo) {
            return parent::getSeries($seriesId);
        } else {
            return $this->___callPlugins('getSeries', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllSeries');
        if (!$pluginInfo) {
            return parent::getAllSeries();
        } else {
            return $this->___callPlugins('getAllSeries', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getChartUrl');
        if (!$pluginInfo) {
            return parent::getChartUrl($directUrl);
        } else {
            return $this->___callPlugins('getChartUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setAxisLabels');
        if (!$pluginInfo) {
            return parent::setAxisLabels($axis, $labels);
        } else {
            return $this->___callPlugins('setAxisLabels', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setHtmlId');
        if (!$pluginInfo) {
            return parent::setHtmlId($htmlId);
        } else {
            return $this->___callPlugins('setHtmlId', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getDataHelper()
    {
        ...
        if (!$pluginInfo) {
            return parent::getDataHelper();
        } else {
            return $this->___callPlugins('getDataHelper', func_get_args(), $pluginInfo);
        }
    }
