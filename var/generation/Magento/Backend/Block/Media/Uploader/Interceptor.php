...
class Interceptor extends \Magento\Backend\Block\Media\Uploader implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFileSizeService');
        if (!$pluginInfo) {
            return parent::getFileSizeService();
        } else {
            return $this->___callPlugins('getFileSizeService', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConfigJson');
        if (!$pluginInfo) {
            return parent::getConfigJson();
        } else {
            return $this->___callPlugins('getConfigJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUploaderUrl');
        if (!$pluginInfo) {
            return parent::getUploaderUrl($url);
        } else {
            return $this->___callPlugins('getUploaderUrl', func_get_args(), $pluginInfo);
        }
    }
