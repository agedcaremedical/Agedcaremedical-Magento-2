...
class Interceptor extends \Magento\Backend\Block\Widget\Grid\Massaction implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getItemsJson()
    {
        ...
        if (!$pluginInfo) {
            return parent::getItemsJson();
        } else {
            return $this->___callPlugins('getItemsJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getFormFieldName()
    {
        ...
        if (!$pluginInfo) {
            return parent::getFormFieldName();
        } else {
            return $this->___callPlugins('getFormFieldName', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getFormFieldNameInternal()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getFormFieldNameInternal', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getGridJsObjectName()
    {
        ...
        if (!$pluginInfo) {
            return parent::getGridJsObjectName();
        } else {
            return $this->___callPlugins('getGridJsObjectName', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSelectedJson()
    {
        ...
        if (!$pluginInfo) {
            return parent::getSelectedJson();
        } else {
            return $this->___callPlugins('getSelectedJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSelected()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getSelected', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getApplyButtonHtml()
    {
        ...
        if (!$pluginInfo) {
            return parent::getApplyButtonHtml();
        } else {
            return $this->___callPlugins('getApplyButtonHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getJavaScript()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getJavaScript', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getGridIdsJson()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getGridIdsJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getUseSelectAll()
    {
        ...
        if (!$pluginInfo) {
            return parent::getUseSelectAll();
        } else {
            return $this->___callPlugins('getUseSelectAll', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setUseSelectAll($flag)
    {
        ...
        if (!$pluginInfo) {
            return parent::setUseSelectAll($flag);
        } else {
            return $this->___callPlugins('setUseSelectAll', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'prepareMassactionColumn');
        if (!$pluginInfo) {
            return parent::prepareMassactionColumn();
        } else {
            return $this->___callPlugins('prepareMassactionColumn', func_get_args(), $pluginInfo);
        }
    }
