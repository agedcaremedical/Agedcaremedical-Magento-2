...
class Interceptor extends \Magento\ConfigurableProduct\Block\Adminhtml\Product\Edit\Tab\Variations\Config\Matrix implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getVariations()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getVariations', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getProvider()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getProvider', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getModal()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getModal', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getConfigurableModal()
    {
        ...
        if (!$pluginInfo) {
            return parent::getConfigurableModal();
        } else {
            return $this->___callPlugins('getConfigurableModal', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getEditProductUrl($id)
    {
        ...
        if (!$pluginInfo) {
            return parent::getEditProductUrl($id);
        } else {
            return $this->___callPlugins('getEditProductUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getVariationWizard($initData)
    {
        ...
        if (!$pluginInfo) {
            return parent::getVariationWizard($initData);
        } else {
            return $this->___callPlugins('getVariationWizard', func_get_args(), $pluginInfo);
        }
    }
