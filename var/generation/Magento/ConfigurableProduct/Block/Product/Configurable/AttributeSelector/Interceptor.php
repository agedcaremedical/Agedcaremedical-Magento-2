...
class Interceptor extends \Magento\ConfigurableProduct\Block\Product\Configurable\AttributeSelector implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttributeSetCreationUrl');
        if (!$pluginInfo) {
            return parent::getAttributeSetCreationUrl();
        } else {
            return $this->___callPlugins('getAttributeSetCreationUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSuggestWidgetOptions');
        if (!$pluginInfo) {
            return parent::getSuggestWidgetOptions();
        } else {
            return $this->___callPlugins('getSuggestWidgetOptions', func_get_args(), $pluginInfo);
        }
    }
