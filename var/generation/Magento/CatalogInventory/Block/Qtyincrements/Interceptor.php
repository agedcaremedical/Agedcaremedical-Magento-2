...
class Interceptor extends \Magento\CatalogInventory\Block\Qtyincrements implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductQtyIncrements');
        if (!$pluginInfo) {
            return parent::getProductQtyIncrements();
        } else {
            return $this->___callPlugins('getProductQtyIncrements', func_get_args(), $pluginInfo);
        }
    }
