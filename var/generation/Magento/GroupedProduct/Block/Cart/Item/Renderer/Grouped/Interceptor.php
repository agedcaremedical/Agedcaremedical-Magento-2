...
class Interceptor extends \Magento\GroupedProduct\Block\Cart\Item\Renderer\Grouped implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGroupedProduct');
        if (!$pluginInfo) {
            return parent::getGroupedProduct();
        } else {
            return $this->___callPlugins('getGroupedProduct', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'overrideProductUrl');
        if (!$pluginInfo) {
            return parent::overrideProductUrl($productUrl);
        } else {
            return $this->___callPlugins('overrideProductUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFormatedOptionValue');
        if (!$pluginInfo) {
            return parent::getFormatedOptionValue($optionValue);
        } else {
            return $this->___callPlugins('getFormatedOptionValue', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isProductVisible');
        if (!$pluginInfo) {
            return parent::isProductVisible();
        } else {
            return $this->___callPlugins('isProductVisible', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductAdditionalInformationBlock');
        if (!$pluginInfo) {
            return parent::getProductAdditionalInformationBlock();
        } else {
            return $this->___callPlugins('getProductAdditionalInformationBlock', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setQtyMode');
        if (!$pluginInfo) {
            return parent::setQtyMode($strict);
        } else {
            return $this->___callPlugins('setQtyMode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIgnoreProductUrl');
        if (!$pluginInfo) {
            return parent::setIgnoreProductUrl($ignore);
        } else {
            return $this->___callPlugins('setIgnoreProductUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getProductPriceHtml(\Magento\Catalog\Model\Product $product)
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductPriceHtml($product);
        } else {
    ...
    public function convertPrice($amount, $format = false)
    {
        ...
        if (!$pluginInfo) {
            return parent::convertPrice($amount, $format);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUnitPriceHtml');
        if (!$pluginInfo) {
            return parent::getUnitPriceHtml($item);
        } else {
            return $this->___callPlugins('getUnitPriceHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRowTotalHtml');
        if (!$pluginInfo) {
            return parent::getRowTotalHtml($item);
        } else {
            return $this->___callPlugins('getRowTotalHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSidebarItemPriceHtml');
        if (!$pluginInfo) {
            return parent::getSidebarItemPriceHtml($item);
        } else {
            return $this->___callPlugins('getSidebarItemPriceHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUnitPriceExclTaxHtml');
        if (!$pluginInfo) {
            return parent::getUnitPriceExclTaxHtml($item);
        } else {
            return $this->___callPlugins('getUnitPriceExclTaxHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUnitPriceInclTaxHtml');
        if (!$pluginInfo) {
            return parent::getUnitPriceInclTaxHtml($item);
        } else {
            return $this->___callPlugins('getUnitPriceInclTaxHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRowTotalExclTaxHtml');
        if (!$pluginInfo) {
            return parent::getRowTotalExclTaxHtml($item);
        } else {
            return $this->___callPlugins('getRowTotalExclTaxHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRowTotalInclTaxHtml');
        if (!$pluginInfo) {
            return parent::getRowTotalInclTaxHtml($item);
        } else {
            return $this->___callPlugins('getRowTotalInclTaxHtml', func_get_args(), $pluginInfo);
        }
    }
