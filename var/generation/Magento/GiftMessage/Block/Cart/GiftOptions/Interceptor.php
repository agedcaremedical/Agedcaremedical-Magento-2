...
class Interceptor extends \Magento\GiftMessage\Block\Cart\GiftOptions implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGiftOptionsConfigJson');
        if (!$pluginInfo) {
            return parent::getGiftOptionsConfigJson();
        } else {
            return $this->___callPlugins('getGiftOptionsConfigJson', func_get_args(), $pluginInfo);
        }
    }
