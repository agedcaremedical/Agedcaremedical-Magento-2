...
class Interceptor extends \Magento\Config\Block\System\Config\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function initForm()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('initForm', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function initFields(\Magento\Framework\Data\Form\Element\Fieldset $fieldset, \Magento\Config\Model\Config\Structure\Element\Group $group, \Magento\Config\Model\Config\Structure\Element\Section $section, $fieldPrefix = '', $labelPrefix = '')
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('initFields', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getConfigValue($path)
    {
        ...
        if (!$pluginInfo) {
            return parent::getConfigValue($path);
        } else {
    ...
    public function canUseDefaultValue($fieldValue)
    {
        ...
        if (!$pluginInfo) {
            return parent::canUseDefaultValue($fieldValue);
        } else {
            return $this->___callPlugins('canUseDefaultValue', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function canUseWebsiteValue($fieldValue)
    {
        ...
        if (!$pluginInfo) {
            return parent::canUseWebsiteValue($fieldValue);
        } else {
            return $this->___callPlugins('canUseWebsiteValue', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isCanRestoreToDefault($fieldValue)
    {
        ...
        if (!$pluginInfo) {
            return parent::isCanRestoreToDefault($fieldValue);
        } else {
            return $this->___callPlugins('isCanRestoreToDefault', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getScopeLabel(\Magento\Config\Model\Config\Structure\Element\Field $field)
    {
        ...
        if (!$pluginInfo) {
            return parent::getScopeLabel($field);
        } else {
    ...
    public function getScopeCode()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getScopeCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getScopeId()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getScopeId', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSectionCode()
    {
        ...
        if (!$pluginInfo) {
            return parent::getSectionCode();
        } else {
            return $this->___callPlugins('getSectionCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getWebsiteCode()
    {
        ...
        if (!$pluginInfo) {
            return parent::getWebsiteCode();
        } else {
            return $this->___callPlugins('getWebsiteCode', func_get_args(), $pluginInfo);
        }
    }
