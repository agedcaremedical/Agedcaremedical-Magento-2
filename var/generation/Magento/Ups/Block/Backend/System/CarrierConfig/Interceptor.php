...
class Interceptor extends \Magento\Ups\Block\Backend\System\CarrierConfig implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getCarrierConfig()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCarrierConfig();
        } else {
            return $this->___callPlugins('getCarrierConfig', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getWebsiteModel()
    {
        ...
        if (!$pluginInfo) {
            return parent::getWebsiteModel();
        } else {
            return $this->___callPlugins('getWebsiteModel', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getConfig($path, $store = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getConfig($path, $store);
        } else {
