...
class Interceptor extends \Magento\Catalog\Block\Product\View\Additional implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getChildHtmlList');
        if (!$pluginInfo) {
            return parent::getChildHtmlList();
        } else {
            return $this->___callPlugins('getChildHtmlList', func_get_args(), $pluginInfo);
        }
    }
