...
class Interceptor extends \Magento\Catalog\Block\Product\View\Options\Type\Date implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function useCalendar()
    {
        ...
        if (!$pluginInfo) {
            return parent::useCalendar();
        } else {
            return $this->___callPlugins('useCalendar', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getDateHtml()
    {
        ...
        if (!$pluginInfo) {
            return parent::getDateHtml();
        } else {
            return $this->___callPlugins('getDateHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCalendarDateHtml()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCalendarDateHtml();
        } else {
            return $this->___callPlugins('getCalendarDateHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getDropDownsDateHtml()
    {
        ...
        if (!$pluginInfo) {
            return parent::getDropDownsDateHtml();
        } else {
            return $this->___callPlugins('getDropDownsDateHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getTimeHtml()
    {
        ...
        if (!$pluginInfo) {
            return parent::getTimeHtml();
        } else {
            return $this->___callPlugins('getTimeHtml', func_get_args(), $pluginInfo);
        }
    }
