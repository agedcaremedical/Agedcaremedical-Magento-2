...
class Interceptor extends \Magento\Catalog\Block\Adminhtml\Product\Helper\Form\Gallery\Content implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getUploader()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getUploader', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUploaderHtml');
        if (!$pluginInfo) {
            return parent::getUploaderHtml();
        } else {
            return $this->___callPlugins('getUploaderHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddImagesButton');
        if (!$pluginInfo) {
            return parent::getAddImagesButton();
        } else {
            return $this->___callPlugins('getAddImagesButton', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImagesJson');
        if (!$pluginInfo) {
            return parent::getImagesJson();
        } else {
            return $this->___callPlugins('getImagesJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImagesValuesJson');
        if (!$pluginInfo) {
            return parent::getImagesValuesJson();
        } else {
            return $this->___callPlugins('getImagesValuesJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasUseDefault');
        if (!$pluginInfo) {
            return parent::hasUseDefault();
        } else {
            return $this->___callPlugins('hasUseDefault', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImageTypesJson');
        if (!$pluginInfo) {
            return parent::getImageTypesJson();
        } else {
            return $this->___callPlugins('getImageTypesJson', func_get_args(), $pluginInfo);
        }
    }
