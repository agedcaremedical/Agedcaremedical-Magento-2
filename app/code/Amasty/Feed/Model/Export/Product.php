...
//        exit;
    ...
    protected function getExportData()
    {
        ...
        if (is_array($this->collectedMultiselectsData)) {
            foreach ($this->collectedMultiselectsData as $storeId => $storeData) {
                foreach($storeData as $productId => $productData){
                    foreach($productData as $productAttr => $values){
                        $rawData[$productId][$storeId][$productAttr] = implode(', ', $values);
                    }
                }
